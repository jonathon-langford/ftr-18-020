...
fInput = "ntuples/ttHLep_signal_%s_M125.root"%processID
chain.Add( fInput )
...
#Output file names
fOutput0 = "output_ttHLep_%sgen0_M125_1fb.root"%processID
fOutput1 = "output_ttHLep_%sgen1_M125_1fb.root"%processID
fOutput2 = "output_ttHLep_%sgen2_M125_1fb.root"%processID
fOutput3 = "output_ttHLep_%sgen3_M125_1fb.root"%processID
fOutput4 = "output_ttHLep_%sgen4_M125_1fb.root"%processID
fOutput5 = "output_ttHLep_%sgen5_M125_1fb.root"%processID
