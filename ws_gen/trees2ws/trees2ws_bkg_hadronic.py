...
def add_recobin_dataset_to_workspace(data=None,ws=None,reco_name=None):
  ...
  for index,row in recobin_data.iterrows():
    ...
    #FOR DIPHOTON + GJET
    #depending on BDT category:
    #if 'BDTb' in reco_name: w_val = row['weight_LO']*3000*1.189066059
    #elif 'BDTa' in reco_name: w_val = row['weight_LO']*3000*1.1937697
    #else: w_val = row['weight_LO']*3000*1.19030997
...
#export ws to file
f_out = ROOT.TFile.Open("ttHHad_ws/bkg_separated_3000fb/output_"+processID+"_13TeV.root","RECREATE")
