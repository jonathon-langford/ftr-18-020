...
chain_ggH_nominal.Add( "/vols/build/cms/jl2117/trilinear/CMSSW_8_1_0/src/triFinalFit/btag_correction/systematics/input/ttHLep/nominal/output_ttHLep_ggH_M125.root" )
chain_VH_nominal.Add( "/vols/build/cms/jl2117/trilinear/CMSSW_8_1_0/src/triFinalFit/btag_correction/systematics/input/ttHLep/nominal/output_ttHLep_VH_M125.root" )
chain_THQ_nominal.Add( "/vols/build/cms/jl2117/trilinear/CMSSW_8_1_0/src/triFinalFit/btag_correction/systematics/input/ttHLep/nominal/output_ttHLep_THQ_M125.root" )
chain_THW_nominal.Add( "/vols/build/cms/jl2117/trilinear/CMSSW_8_1_0/src/triFinalFit/btag_correction/systematics/input/ttHLep/nominal/output_ttHLep_THW_M125.root" )
...
chain_ggH_syst_up.Add( "/vols/build/cms/jl2117/trilinear/CMSSW_8_1_0/src/triFinalFit/btag_correction/systematics/input/ttHLep/%s/output_ttHLep_ggH_M125_%s_up.root"%(syst_type,syst_type) )
chain_VH_syst_up.Add( "/vols/build/cms/jl2117/trilinear/CMSSW_8_1_0/src/triFinalFit/btag_correction/systematics/input/ttHLep/%s/output_ttHLep_VH_M125_%s_up.root"%(syst_type,syst_type) )
...
chain_ggH_syst_down.Add( "/vols/build/cms/jl2117/trilinear/CMSSW_8_1_0/src/triFinalFit/btag_correction/systematics/input/ttHLep/%s/output_ttHLep_ggH_M125_%s_down.root"%(syst_type,syst_type) )
chain_VH_syst_down.Add( "/vols/build/cms/jl2117/trilinear/CMSSW_8_1_0/src/triFinalFit/btag_correction/systematics/input/ttHLep/%s/output_ttHLep_VH_M125_%s_down.root"%(syst_type,syst_type) )
