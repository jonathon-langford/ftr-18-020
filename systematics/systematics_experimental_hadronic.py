...
chain_VH_nominal = ROOT.TChain("trilinearTree")
...
chain_VH_syst_up = ROOT.TChain("trilinearTree")
...
chain_VH_syst_down = ROOT.TChain("trilinearTree")
chain_THQ_syst_down = ROOT.TChain("trilinearTree")
chain_THW_syst_down = ROOT.TChain("trilinearTree")

#Add relevant files to chains
chain_ttH_nominal.Add( "/vols/build/cms/jl2117/trilinear/CMSSW_8_1_0/src/triFinalFit/btag_correction/systematics/input/ttHHad/nominal/output_ttHHad_ttH_M125.root" )
...
chain_VH_nominal.Add( "/vols/build/cms/jl2117/trilinear/CMSSW_8_1_0/src/triFinalFit/btag_correction/systematics/input/ttHHad/nominal/output_ttHHad_VH_M125.root" )
chain_THQ_nominal.Add( "/vols/build/cms/jl2117/trilinear/CMSSW_8_1_0/src/triFinalFit/btag_correction/systematics/input/ttHHad/nominal/output_ttHHad_THQ_M125.root" )
chain_THW_nominal.Add( "/vols/build/cms/jl2117/trilinear/CMSSW_8_1_0/src/triFinalFit/btag_correction/systematics/input/ttHHad/nominal/output_ttHHad_THW_M125.root" )

chain_ttH_syst_up.Add( "/vols/build/cms/jl2117/trilinear/CMSSW_8_1_0/src/triFinalFit/btag_correction/systematics/input/ttHHad/%s/output_ttHHad_ttH_M125_%s_up.root"%(syst_type,syst_type) )
...
chain_VH_syst_up.Add( "/vols/build/cms/jl2117/trilinear/CMSSW_8_1_0/src/triFinalFit/btag_correction/systematics/input/ttHHad/%s/output_ttHHad_VH_M125_%s_up.root"%(syst_type,syst_type) )
chain_THQ_syst_up.Add( "/vols/build/cms/jl2117/trilinear/CMSSW_8_1_0/src/triFinalFit/btag_correction/systematics/input/ttHHad/%s/output_ttHHad_THQ_M125_%s_up.root"%(syst_type,syst_type) )
chain_THW_syst_up.Add( "/vols/build/cms/jl2117/trilinear/CMSSW_8_1_0/src/triFinalFit/btag_correction/systematics/input/ttHHad/%s/output_ttHHad_THW_M125_%s_up.root"%(syst_type,syst_type) )

chain_ttH_syst_down.Add( "/vols/build/cms/jl2117/trilinear/CMSSW_8_1_0/src/triFinalFit/btag_correction/systematics/input/ttHHad/%s/output_ttHHad_ttH_M125_%s_down.root"%(syst_type,syst_type) )
...
chain_VH_syst_down.Add( "/vols/build/cms/jl2117/trilinear/CMSSW_8_1_0/src/triFinalFit/btag_correction/systematics/input/ttHHad/%s/output_ttHHad_VH_M125_%s_down.root"%(syst_type,syst_type) )
chain_THQ_syst_down.Add( "/vols/build/cms/jl2117/trilinear/CMSSW_8_1_0/src/triFinalFit/btag_correction/systematics/input/ttHHad/%s/output_ttHHad_THQ_M125_%s_down.root"%(syst_type,syst_type) )
chain_THW_syst_down.Add( "/vols/build/cms/jl2117/trilinear/CMSSW_8_1_0/src/triFinalFit/btag_correction/systematics/input/ttHHad/%s/output_ttHHad_THW_M125_%s_down.root"%(syst_type,syst_type) )
...
chains_VH.extend([ chain_VH_nominal, chain_VH_syst_up, chain_VH_syst_down ])
...
##################################################
#VH:
for chain_idx in range( len(chains_VH) ):
  print "VH: chain = %g, entries = %g"%(chain_idx,chains_VH[chain_idx].GetEntries())
  #1) nominal, 2) syst up, 3) syst down
  #Re-set counters
  for i in range(0,n_proc):
    for j in range(0,n_cats):
  ...
  #Push deepcopy back onto N_ttH list
  N_VH.append( deepcopy(N_tmp) )

#Calc ratio of up to down
syst_VH_up = (np.array( N_VH[1] )/np.array( N_VH[0] )).tolist()
syst_VH_down = (np.array( N_VH[2] )/np.array( N_VH[0] )).tolist()


print "VH:      N =", N_VH[0]
print "VH:   N_up =", N_VH[1]
print "VH: N_down =", N_VH[2]
print "VH:   %s_up ="%(syst_type), syst_VH_up
print "VH: %s_down ="%(syst_type), syst_VH_down
print ""
...
proc_dict = {'ttH':[syst_ttH_up,syst_ttH_down],'ggH':[syst_ggH_up,syst_ggH_down],'VH':[syst_VH_up,syst_VH_down],'tHq':[syst_THQ_up,syst_THQ_down],'tHW':[syst_THW_up,syst_THW_down]}
