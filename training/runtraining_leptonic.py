...
(r.TMVA.gConfig().GetIONames()).fWeightFileDir="weights_leptonic"
fin     = r.TFile.Open("bdt_trees_leptonic.root")
tree_s = fin.Get("tree_s")
tree_b = fin.Get("tree_b")

fout     = r.TFile("classification_leptonic.root","RECREATE")
...
factory.AddVariable("Nleptons","N leptons"," ","F")
factory.AddVariable("scalarHT","HT","GeV","F")	
factory.AddVariable("MET","p_{T}^{miss}","GeV","F")		
factory.AddVariable("mindphi_gg_l","min #Delta#phi(#gamma#gamma,l)","","F")		
...
factory.AddVariable("lep_pt" ,"p_{T}^{l}","GeV","F")		
factory.AddVariable("lep_eta","|#eta^{l}|"," ","F")	
...
factory.BookMethod(r.TMVA.Types.kBDT,"BDTG","!H:!V:NTrees=250:BoostType=Grad:MaxDepth=6:Shrinkage=0.1:UseBaggedBoost:GradBaggingFraction=0.1");
