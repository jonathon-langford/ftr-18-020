...
Label 	    = "#splitline{ttH + tH, H#rightarrow#gamma#gamma}{Hadronic}"
L           = 3000 # = 100/fb
signalScale = 1
minWeight   = -9.e100
#odir 	    = "plots_extendtracker_preselection_cutBDT_gt_0p45"
#odir 	    = "plots_ttH_hadronic_preapp_cutBDT"
odir 	    = "plots_ttH_hadronic_preapp"

cut_markers = [0.28, 0.61]
#cutBDTMinimum = 0.28
cutBDTMinimum = -1
...
variables = { 
	   "bdt_class":["Hadronic BDT output",17,-0.7,1,True,0,[],[]] 
...
fout    = ROOT.TFile("optimisation_hadronic_output.root","RECREATE")
fout.cd()
...
tmvaReader_.BookMVA("BDTG","weights_hadronic/TMVAClassification_BDTG.weights.xml")
...
def doAnalysis(tr,entry,i,w):
     ...
     b_scalarHT[0]	= tr.jet1_pT+tr.jet2_pT+tr.jet3_pT + (max(0,tr.jet4_pT)) # tr.scalarHT 
     b_MET[0]      	= tr.MET
