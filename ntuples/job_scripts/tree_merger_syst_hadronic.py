...
if len( sys.argv ) < 4:
  print "Usage: python tree_merger_syst_ttHHad.py <processID> <systematic> <direction>"
...
baseName = "ttHHad_tri_ntuples_syst/%s/%s/%s_"%(syst_type,processID,processID)
output_file = "ttHHad_tri_ntuples_syst/%s/ttHHad_syst_%s_M125_%s_%s.root"%(syst_type,processID,syst_type,syst_direction)
