...
if len( sys.argv ) < 2:
  print "Usage: python tree_merger_signal_ttHLep.py <processID>"
...
baseName = "ttHLep_tri_ntuples_signal/%s/%s_"%(processID,processID)
output_file = "ttHLep_tri_ntuples_signal/ttHLep_signal_%s_M125_bugged.root"%processID
