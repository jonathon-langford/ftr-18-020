...
if( background_type == "ttgammagamma" ): filename = "ttHHad_tri_ntuples_background/ttgammagamma/ttgammagamma_" + nOut  + ".root" 
elif( background_type == "ttgamma_singlelepfromt" ): filename = "ttHHad_tri_ntuples_background/ttgamma/ttgamma_singlelepfromt_" + nOut  + ".root" 
elif( background_type == "ttgamma_singlelepfromtbar" ): filename = "ttHHad_tri_ntuples_background/ttgamma/ttgamma_singlelepfromtbar_" + nOut  + ".root" 
elif( background_type == "ttgamma_hadronic" ): filename = "ttHHad_tri_ntuples_background/ttgamma/ttgamma_hadronic_" + nOut  + ".root"
elif( background_type == "ttgamma_dilepton" ): filename = "ttHHad_tri_ntuples_background/ttgamma/ttgamma_dilepton_" + nOut  + ".root"
elif( background_type == "ttbar" ): filename = "ttHHad_tri_ntuples_background/ttbar/ttbar_" + nOut  + ".root"
elif( background_type == "TGJet" ): filename = "ttHHad_tri_ntuples_background/tgjet/tgjet_" + nOut  + ".root"
elif( background_type == "QCD" ): filename = "ttHHad_tri_ntuples_background/qcd/qcd_" + nOut  + ".root"
elif( background_type == "GJet" ): filename = "ttHHad_tri_ntuples_background/gjet/gjet_" + nOut  + ".root"
elif( background_type == "diphoton" ): filename = "ttHHad_tri_ntuples_background/gg/gg_" + nOut  + ".root"
...
#	EVENTS PASSING SELECTION
  if(photons_pass) & (leptonVeto_pass) & (top_pass):
