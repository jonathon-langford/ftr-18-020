...
siteHandling = {
   ...
   ###                  "field"   : 4
   ###                  },
   "desy"    : { "ls"      :  "gfal-ls srm://dcache-se-cms.desy.de/pnfs/desy.de/cms/tier2/%s",
                    "prepend" :  "root://cms-xrd-global.cern.ch//",
                    "prepend_dir" :  True,
                    "field"   : 0
                    },
   "fnal.gov"    : { "ls"      :  "eos root://cmseos.fnal.gov ls %s",
                    "prepend" :  "root://cmseos.fnal.gov//",
                    "prepend_dir" :  True,
                    "field"   : 0
                    },
   "cern.ch"    : { "ls"      :  "/afs/cern.ch/project/eos/installation/ams/bin/eos.select ls %s",
                    "prepend" :  "root://eoscms//eos/cms",
                    "prepend_dir" :  True,
                    "field"   : 0
                    },
